...
public class ProtoBufHandler extends SimpleChannelInboundHandler<Protocol> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, Protocol msg) throws Exception {
        ...
        // 放在Netty循环中跑线程
        MyLogger.log("msg from client is "+msg.toString());
        ...
        if (msg.hasLogin()) {
            ...
            if (result == 0) {
                ...
                status = "success";
                MyLogger.log(userType + " uid:" + uid + " 登录成功:" + ctx);
                Login loginInfo=Login.newBuilder().setUid(111L).setMsgType(10000).setUserName("heheheh").setPassword("hahahahah").build();
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        MyLogger.log("TCP连接建立，ctx:"
                        ...
                        + " channel:"
                        + ctx.channel());
        ctx.writeAndFlush(Protocol.newBuilder().build());
    }
